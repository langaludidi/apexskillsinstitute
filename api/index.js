...
const mobileNavCss=`<style id="apex-mobile-navigation">@media(max-width:980px){html{scroll-padding-top:84px}body{padding-top:74px}header{position:fixed!important;top:0!important;right:0!important;left:0!important;width:100%!important;z-index:1000!important}header nav{position:fixed!important;top:74px!important;right:0!important;bottom:0!important;left:0!important;display:flex!important;flex-direction:column!important;align-items:stretch!important;justify-content:flex-start!important;gap:0!important;width:100%!important;height:auto!important;min-height:0!important;max-height:calc(100dvh - 74px)!important;margin:0!important;padding:18px 22px calc(36px + env(safe-area-inset-bottom))!important;background:#fff!important;z-index:999!important;overflow-x:hidden!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior:contain!important;visibility:hidden!important;opacity:0!important;pointer-events:none!important;transform:translateY(-12px)!important;transition:opacity .2s ease,transform .2s ease,visibility 0s linear .2s!important}header nav.open{visibility:visible!important;opacity:1!important;pointer-events:auto!important;transform:none!important;transition:opacity .2s ease,transform .2s ease!important}header nav a{display:block!important;width:100%!important;flex:0 0 auto!important;margin:0!important;padding:14px 10px!important;color:#07183d!important}header nav .nav-cta{margin-top:8px!important;text-align:center!important}body.menu-open{overflow:hidden!important;overscroll-behavior:none!important}}@media(max-width:600px){html{scroll-padding-top:78px}body{padding-top:68px}header nav{top:68px!important;max-height:calc(100dvh - 68px)!important}}</style>`;
